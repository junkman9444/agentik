...
logger = logging.getLogger("sage_state")  # caplog tests pin the origin module's name
...
def _stale_holder(row, now: float) -> bool:
    ...
    from sage_state import _compression_lock_holder_process_is_dead
...
class SessionMessagesMixin:
    ...
    def _rows_to_conversation(self, rows, *, session_id: str, include_ancestors: bool, repair_alternation: bool,
        ...
        from sage_state import _strip_background_review_harness, _strip_stale_tool_call_markers
        messages = []
    ...
    def purge_stale_tool_call_markers(self, *, dry_run: bool = False, backup: bool = True) -> Dict[str, Any]:
        ...
        from sage_state import _STALE_TOOL_CALL_MARKER_RE
