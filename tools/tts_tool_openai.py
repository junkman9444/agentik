...
# DeepInfra base URL is resolved via sage_cli.models.deepinfra_base_url (shared).
...
def _generate_deepinfra_tts(text: str, output_path: str, tts_config: Dict[str, Any]) -> str:
    """Resolve DeepInfra credentials/model (live ``sage_cli.models`` catalog, no hardcoded ids), then
