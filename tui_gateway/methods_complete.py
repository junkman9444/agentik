...
@_catch(5033)
def _(rid, params: dict) -> dict:
    from sage_cli.inventory import build_model_options_payload
...
def _(rid, params: dict) -> dict:
    ...
    from sage_cli.config import is_managed
    ...
    from sage_cli.credential_lifecycle import save_provider_env_credential  # also rotates stale config.yaml mirrors
...
def _(rid, params: dict) -> dict:
    ...
    from sage_cli.auth import PROVIDER_REGISTRY, clear_provider_auth
