...
def _other_runtime_lease_guard(session_id: str, session: dict):
    ...
    try:
        from sage_cli.active_sessions import active_session_liveness_guard, release_active_session_liveness_guard
    except Exception as exc:
...
def _transfer_active_session_slot(sid: str, session: dict, *, new_session_id: str) -> bool:
    ...
    if lease is None:
        return True
    try:
        from sage_cli.active_sessions import transfer_active_session
