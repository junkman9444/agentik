...
def _wire_callbacks(sid: str):
    ...
    def secret_cb(env_var, prompt, metadata=None):
        ...
        from sage_cli.config import save_env_value_secure
...
def _available_personalities(cfg: dict | None = None) -> dict:
    """Built-ins + user overrides, via sage_cli.personality (single owner)."""
...
def _validate_personality(value: str, cfg: dict | None = None) -> tuple[str, str]:
    ...
    from sage_cli.personality import normalize_personality_name, render_personality_prompt
...
def _prompt_text(value) -> str:
    """Normalize config prompt values from YAML for AIAgent (sage_cli.personality owns this)."""
    from sage_cli.personality import prompt_text
