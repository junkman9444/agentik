...
class _SlashWorker:
    ...
    def __init__(self, session_key: str, model: str, profile_home: str | None = None):
        ...
        # (applied last, always wins) instead of a hand-rolled env["SAGE_HOME"] assignment.
        ...
        env = _prepend_tool_paths(build_subprocess_env(
            ...
            inherit_profile_home=False, extra={"SAGE_HOME": str(profile_home)} if profile_home else None))
