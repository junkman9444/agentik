...
# ``sage_cli/plugins.py:10-12``.  The guard only checked the bundled
...
# this script runs as a standalone subprocess — ``sage_constants`` isn't
...
def main() -> int:
    ...
    # Add repo root to sys.path so we can import sage_constants (this script
    ...
    if os.environ.get("HERMES_ENABLE_PROJECT_PLUGINS"):
        plugin_roots.append(Path.cwd() / ".sage" / "plugins")
