...
def live_home(monkeypatch):
    ...
    # sage_constants caches the resolved home at first read — the env var
    ...
    import sage_cli.config as hconfig
    ...
    # conftest also re-pins sage_state.DEFAULT_DB_PATH per test; pin it to
