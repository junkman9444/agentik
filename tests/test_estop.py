...
def test_cli_pause_engages_with_reason(hermes_home, capsys):
    from sage_cli.subcommands.pause import cmd_pause
...
def test_cli_resume_disengages(hermes_home, capsys):
    from sage_cli.subcommands.pause import cmd_pause, cmd_resume
...
def test_cli_resume_when_not_paused(hermes_home, capsys):
    from sage_cli.subcommands.pause import cmd_resume
...
def test_builtin_subcommands_include_pause_resume():
    from sage_cli.main import _BUILTIN_SUBCOMMANDS
...
def test_status_line_when_paused(hermes_home):
    from sage_cli.status import _estop_status_line
...
def test_pause_command_registered_for_gateway():
    from sage_cli.commands import GATEWAY_KNOWN_COMMANDS, resolve_command
