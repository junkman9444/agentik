"""Tests for sage_cli/skills_config.py and skills_tool disabled filtering."""
...
class TestSaveDisabledSkills:
    @patch("sage_cli.skills_config.save_config")
...
class TestIsSkillDisabled:
    ...
    @patch("sage_cli.config.load_config")
...
class TestGetCategories:
    def test_extracts_unique_categories(self):
        from sage_cli.skills_config import _get_categories
        skills = [
