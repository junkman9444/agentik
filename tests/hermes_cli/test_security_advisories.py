"""Tests for sage_cli.security_advisories.
...
import sage_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full sage_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "sage_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
