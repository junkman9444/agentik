...
``sage_cli.memory_setup._write_env_vars`` persists provider plugin
...
from sage_cli.config import ensure_hermes_home, get_env_path, load_env
from sage_cli.memory_setup import _write_env_vars
