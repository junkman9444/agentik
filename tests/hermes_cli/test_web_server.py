"""Tests for sage_cli.web_server and related config utilities."""
...
import sage_cli.web_routers.chat_ws as _rt_chat_ws
import sage_cli.web_routers.status as _rt_status
...
import sage_cli.web_server_sessions as _web_server_sessions
...
class TestWebServerEndpoints:
    ...
    def test_startup_eager_reconcile_never_raises(self, monkeypatch):
        ...
        monkeypatch.setattr(sage_state, "SessionDB", boom)
    ...
    def test_heal_gives_up_when_reconcile_cannot_fix_the_store(self, monkeypatch):
        ...
        original_init = sage_state.SessionDB.__init__
        ...
        # the class on sage_state covers every open the helper makes.
        monkeypatch.setattr(sage_state.SessionDB, "__init__", counting_init)
    ...
    def test_generic_corruption_does_not_trigger_writable_heal(
        ...
        monkeypatch.setattr(sage_state, "SessionDB", corrupt_open)
    ...
    def test_decode_error_triggers_writable_heal(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(sage_state, "SessionDB", scripted_open)
    ...
    def test_put_memory_provider_config_writes_config_and_secret(self):
        from sage_constants import get_hermes_home
        from sage_cli.config import load_config, load_env
    ...
    def test_get_media_requires_auth(self):
        from sage_cli.web_server import _SESSION_HEADER_NAME
    ...
    def test_update_hermes_returns_docker_guidance_without_spawning(self, monkeypatch):
        ...
        # method through sage_cli.config directly.
        monkeypatch.setattr(
            "sage_cli.config.detect_install_method", lambda *_a, **_k: "docker"
        )
    ...
    def test_update_hermes_returns_apt_guidance_without_spawning(self, monkeypatch):
        ...
        monkeypatch.setattr(_web_server_files, "_dashboard_local_update_managed_externally", lambda: False)
        # The shared admission gate (#91277 Phase 3) resolves the install
        # method through sage_cli.config directly, so patch it there (the
        # web_server module alias only feeds the /update/check endpoint).
        monkeypatch.setattr(
            "sage_cli.config.detect_install_method", lambda *_a, **_k: "apt"
        )
    ...
    def test_platform_scoped_messaging_env_vars_are_channel_managed(self):
        ...
        tests/sage_cli/test_setup_hidden_env.py.
        """
        from sage_cli.web_server_messaging import _MESSAGING_KEYS_PAGE_KEYS, _build_catalog_entry, _channel_managed_env_keys
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from sage_cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from sage_cli.config import save_env_value
        from sage_cli.web_server import _SESSION_TOKEN
    ...
    def test_parse_model_ids_handles_openai_and_bare_shapes(self):
        ...
        from sage_cli.web_server_profiles import _parse_model_ids
    ...
    def test_deleting_the_active_custom_endpoint_clears_its_model_mirror(self):
        ...
        """
        from sage_cli.config import custom_endpoint_key_env, get_env_value, load_config
    ...
    def test_numeric_yaml_provider_key_can_be_activated_and_deleted(self):
        ...
        """
        from sage_cli.config import get_config_path, load_config
    ...
    def test_custom_endpoint_save_scopes_to_the_requested_profile(self):
        ...
        """
        from sage_cli import profiles as profiles_mod
        from sage_cli.config import custom_endpoint_key_env
        from sage_constants import get_hermes_home
    ...
    def test_custom_endpoint_save_leaves_a_hand_written_env_ref_alone(self, monkeypatch):
        ...
        from sage_cli.config import custom_endpoint_key_env, get_config_path, get_env_value
    ...
    def test_two_endpoints_on_one_host_keep_separate_credentials(self):
        ...
        the first's key.
        """
        from sage_cli.config import custom_endpoint_key_env, get_env_value
...
class TestBuildSchemaFromConfig:
    ...
    def test_overrides_applied(self):
        from sage_cli.web_server_config import CONFIG_SCHEMA
    ...
    def test_timezone_field_is_searchable_select(self):
        ...
        """
        from sage_cli.web_server_config import CONFIG_SCHEMA, _timezone_options
...
class TestConfigRoundTrip:
    ...
    def test_round_trip_preserves_schema_invisible_nested_keys(self):
        ...
        from sage_cli.config import load_config, read_raw_config, save_config
...
class TestNewEndpoints:
    ...
    def test_toolsets_resolve_subscription_features_once(self, monkeypatch):
        ...
        from sage_cli.nous_subscription import NousSubscriptionFeatures
    ...
    def test_get_toolset_config_reports_truthful_provider_status(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sage_cli.nous_subscription.get_nous_portal_account_info",
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from sage_cli.web_server_config import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from sage_cli.web_server_config import _denormalize_config_from_web
...
class TestDenormalizeProviderSwitch:
    ...
    def test_vendor_slug_switches_off_non_aggregator_provider(self):
        ...
        with _patch("sage_cli.models_detect.provider_has_credentials", lambda p: p == "openrouter"):
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_non_dict(self):
        from sage_cli.web_server_dashboard import _normalise_theme_definition
...
class TestBulkDeleteSessionsEndpoint:
    ...
    1. Route-ordering: ``/api/sessions/bulk-delete`` must shadow the
       ...
       the block comment in ``sage_cli/web_server.py``).
    ...
    def test_route_order_not_shadowed_by_session_id(self):
        ...
        assert "deleted" in body, (
            ...
            "registration order in sage_cli/web_server.py."
        )
...
class TestPtyWebSocket:
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from sage_cli.pty_bridge import PtyUnavailableError
    ...
    def test_pub_broadcasts_to_events_subscribers(self):
        ...
        """
        import asyncio
        from sage_cli import web_server as ws_mod
...
def test_resolve_chat_argv_injects_gateway_ws_url(monkeypatch):
    import sage_cli.main_tui_launch as tui_launch
    import sage_cli.web_server as ws
