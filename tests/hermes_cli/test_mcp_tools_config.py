"""Tests for MCP tools interactive configuration in sage_cli.tools_config."""

from unittest.mock import patch

from sage_cli.tools_config import _configure_mcp_tools_interactive
...
_CHECKLIST = "sage_cli.curses_ui.curses_checklist"
_SAVE = "sage_cli.tools_config.save_config"
