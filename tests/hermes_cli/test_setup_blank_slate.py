"""Tests for Blank Slate setup mode (sage_cli/setup.py).
...
from sage_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
