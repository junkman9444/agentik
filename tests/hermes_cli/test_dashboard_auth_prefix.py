...
from sage_cli.dashboard_auth import prefix as prefix_mod
...
class TestPublicUrlOverride:
    ...
    def patch_config(self, monkeypatch):
        """Replace ``sage_cli.config.load_config`` with a stub
...
class TestCookiePathRespectsPrefix:
    ...
    def test_loopback_cookies_unprefixed(self):
        ...
        from sage_cli.dashboard_auth.cookies import set_pkce_cookie
