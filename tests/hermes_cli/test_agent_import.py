"""Tests for sage_cli.agent_import — ``hermes import-agent``.
...
Uses the profile_env fixture pattern from tests/sage_cli/test_profiles.py:
...
from sage_cli.agent_import import (
    ENTRY_DELIMITER,
    AgentImporter,
...
class TestExistingConfigPreserved:
    ...
    def test_failed_write_does_not_truncate_the_existing_config(
        ...
        from sage_cli import agent_import
...
class TestCliWiring:
    ...
    def test_command_dry_run_via_cli_writes_nothing(
        ...
        import types
        from sage_cli.agent_import import import_agent_command
