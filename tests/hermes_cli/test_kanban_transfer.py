"""Tests for kanban board export / import (``sage_cli.kanban_transfer``).
...
from sage_cli import kanban_transfer as kt
from sage_cli.archive_safe import normalize_archive_parts, safe_extract_targz
