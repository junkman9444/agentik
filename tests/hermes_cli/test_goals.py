"""Tests for sage_cli/goals.py — persistent cross-turn goals."""
...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from sage_cli.goals import _parse_judge_response
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from sage_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, hermes_home):
        ...
        from sage_cli import goals
        from sage_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
...
class TestGoalStateSubgoalsBackcompat:
    def test_old_state_meta_row_loads_without_subgoals(self):
        ...
        from sage_cli.goals import GoalState
...
class TestMigrateGoalToSession:
    ...
    def test_migrates_active_goal_to_child(self, hermes_home):
        from sage_cli.goals import save_goal, load_goal, migrate_goal_to_session, GoalState
...
class TestParseContract:
    ...
    def test_inline_fields_parsed(self):
        from sage_cli.goals import parse_contract
...
class TestGoalContractSerialization:
    def test_roundtrip_with_contract(self):
        from sage_cli.goals import GoalState, GoalContract
    ...
    def test_render_block_omits_empty_fields(self):
        from sage_cli.goals import GoalContract
...
class TestGoalManagerContract:
    ...
    def test_set_contract_after_the_fact(self, hermes_home):
        from sage_cli.goals import GoalManager, GoalContract
        ...
        # Survives reload.
        from sage_cli.goals import GoalManager as GM2
