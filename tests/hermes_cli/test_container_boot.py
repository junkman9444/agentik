"""Tests for sage_cli.container_boot — the cont-init.d-time
...
from sage_cli.container_boot import (
    ReconcileAction,
...
def _hermetic_container_argv(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    """
    monkeypatch.setattr(
        "sage_cli.container_boot._read_container_argv",
        lambda: (),
    )
...
def test_main_skips_reconcile_in_dashboard_container_s6v3(
    ...
    """
    from sage_cli import container_boot
