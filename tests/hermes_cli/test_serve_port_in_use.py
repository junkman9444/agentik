...
def test_probe_detects_held_socket():
    from sage_cli.web_server_lifecycle import _port_bind_conflict
...
def test_addr_in_use_error_classification():
    ...
    from sage_cli.web_server_lifecycle import _is_addr_in_use_error
...
def test_exit_code_is_distinct_tempfail():
    from sage_cli.web_server_lifecycle import PORT_IN_USE_EXIT_CODE
