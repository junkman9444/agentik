...
from sage_cli.model_setup_flows_common import _existing_api_key_for_model_flow
...
def test_generic_api_key_flow_passes_pool_key_to_existing_key_prompt(monkeypatch):
    ...
    with (
        ...
        patch("sage_cli.main_provider_setup._prompt_api_key", side_effect=capture_prompt),
    ):
