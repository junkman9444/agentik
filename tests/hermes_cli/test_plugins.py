"""Tests for the Hermes plugin system (sage_cli.plugins)."""
...
from sage_cli.relay_plugin_cutover import RELAY_PLUGINS_CONFIG_ENV
...
class TestPluginDiscovery:
    ...
    def test_removed_relay_plugin_identity_cannot_be_reloaded(
        ...
        from sage_cli import plugins as plugins_mod
    ...
    def test_enabled_portable_plugin_registers_components(
        ...
        from sage_cli.agent_plugins import MCP_SCHEMA_V1, PLUGIN_SCHEMA_V1
        from sage_cli import plugins as plugins_mod
...
class TestPluginLoading:
    ...
    def test_entrypoint_memory_provider_auto_coerced_to_exclusive(
        ...
        monkeypatch.setattr(
            "sage_cli.plugins.importlib.metadata.entry_points",
...
class TestDeliveryParity:
    ...
    def _fresh_manager(self, monkeypatch, register_body):
        ...
        import sage_cli.plugins as plugins_mod
...
class TestForceReloadSymmetry:
    ...
    def test_re_register_config_hooks_clears_idempotence_set(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sage_cli.config.load_config", lambda: {"hooks": {}}
        )
    ...
    def test_hook_timeout_does_not_block_caller(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sage_cli.plugins._resolve_hook_callback_timeout", lambda: 0.15
        )
    ...
    def test_hook_callback_within_timeout_returns_value(self, monkeypatch):
        monkeypatch.setattr(
            "sage_cli.plugins._resolve_hook_callback_timeout", lambda: 1.0
        )
        mgr = PluginManager()
    ...
    def test_hung_callback_suppresses_repeat_fires(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sage_cli.plugins._resolve_hook_callback_timeout", lambda: 0.1
        )
    ...
    def test_pre_tool_call_worker_start_failure_fails_closed_without_sticking(
        ...
        from sage_cli.plugins import _PRE_TOOL_CALL_TIMEOUT_BLOCK_MESSAGE
...
class TestPreToolCallDirective:
    ...
    def test_first_party_observer_receives_pre_tool_call(self, monkeypatch):
        from sage_cli import observability
        from sage_cli.plugins import get_pre_tool_call_directive
...
class TestResolvePreToolBlock:
    ...
    def test_approve_gate_receives_tool_observability_context(self, monkeypatch):
        from sage_cli.plugins import resolve_pre_tool_block
...
class TestGetPreVerifyContinueMessage:
    ...
    def test_none_when_no_hooks(self, monkeypatch):
        monkeypatch.setattr("sage_cli.plugins.invoke_hook", lambda hook_name, **kwargs: [])
    ...
    def test_forwards_scope_signals_to_hooks(self, monkeypatch):
        ...
        monkeypatch.setattr("sage_cli.plugins.invoke_hook", capture)
...
class TestPluginContext:
    ...
    def test_register_tool_override_blocked_without_operator_opt_in(self, tmp_path, monkeypatch):
        ...
        from sage_cli.plugins import PluginToolOverrideError
        ...
        try:
            ...
            from sage_cli.plugins import PluginContext, PluginManifest
...
class TestPluginCommands:
    ...
    def test_plugin_manager_scoped_by_hermes_home_override(self, tmp_path):
        ...
        ``sage_constants.set_hermes_home_override`` — deliberately does
...
class TestPluginCommandResultResolution:
    ...
    def test_awaits_async_result_with_running_loop(self, monkeypatch):
        ...
        monkeypatch.setattr("sage_cli.plugins.asyncio.get_running_loop", lambda: _Loop())
    ...
    def test_running_loop_timeout_does_not_hang_forever(self, monkeypatch):
        ...
        monkeypatch.setattr("sage_cli.plugins.asyncio.get_running_loop", lambda: _Loop())
        monkeypatch.setattr("sage_cli.plugins._PLUGIN_COMMAND_AWAIT_TIMEOUT_SECS", 0.1)
...
class TestPluginDispatchTool:
    ...
    def test_dispatch_tool_calls_registry(self):
        ...
        with patch("sage_cli.plugins.PluginContext.dispatch_tool.__module__", "sage_cli.plugins"):
