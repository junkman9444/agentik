"""Tests for the shared byte formatter (sage_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from sage_cli.backup import _format_size as backup
    from sage_cli.checkpoints import _fmt_bytes as checkpoints
    from sage_cli.sizefmt import format_bytes as doctor
