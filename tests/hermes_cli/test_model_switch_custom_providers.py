...
import sage_cli.providers as providers_mod
import pytest
import yaml
from sage_cli.model_switch import list_authenticated_providers, switch_model
from sage_cli.model_switch_providers import _fetch_picker_live_models, _save_discovered_models_to_config
...
def _disable_live_custom_provider_model_probe(monkeypatch):
    ...
    monkeypatch.setattr(
        "sage_cli.models.cached_provider_model_ids", lambda *_a, **_kw: []
    )
    monkeypatch.setattr(
        "sage_cli.models.provider_model_ids", lambda *_a, **_kw: []
    )
    monkeypatch.setattr(
        "sage_cli.models_local.fetch_ollama_local_models", lambda *_a, **_kw: None
    )


def test_picker_native_probe_failure_falls_back_to_openai_catalog(monkeypatch):
    monkeypatch.setattr(
        "sage_cli.models_local.should_use_ollama_native_catalog", lambda *a, **k: True
    )
    monkeypatch.setattr(
        "sage_cli.models._get_ollama_native_headers", lambda *a, **k: {}
    )
    monkeypatch.setattr(
        "sage_cli.models_local.fetch_ollama_local_models", lambda *a, **k: None
    )
    monkeypatch.setattr(
        "sage_cli.models.fetch_api_models", lambda *a, **k: ["fallback-model"]
    )
...
def test_picker_generic_discovery_preserves_api_mode(monkeypatch):
    ...
    monkeypatch.setattr(
        "sage_cli.models_local.should_use_ollama_native_catalog", lambda *a, **k: False
    )
    monkeypatch.setattr("sage_cli.models.cached_fetch_api_models", cached)
...
def test_list_authenticated_providers_includes_custom_providers(monkeypatch):
    ...
    monkeypatch.setattr("sage_cli.models.fetch_api_models", lambda *a, **k: [])
...
def test_list_authenticated_providers_can_skip_custom_provider_live_probe(monkeypatch):
    ...
    monkeypatch.setattr("sage_cli.models.fetch_api_models", fetch)
...
def test_switch_model_accepts_explicit_bare_custom_current_endpoint(monkeypatch):
    ...
    monkeypatch.setattr("sage_cli.models_validate.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
    monkeypatch.setattr("sage_cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr("sage_cli.model_switch.get_model_capabilities", lambda *a, **k: None)
...
def test_switch_model_does_not_send_ollama_headers_to_unrelated_custom_endpoint(monkeypatch):
    ...
    monkeypatch.setattr(
        "sage_cli.models_local._get_ollama_request_headers",
    ...
    monkeypatch.setattr("sage_cli.models_validate.validate_requested_model", fake_validation)
    monkeypatch.setattr("sage_cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr("sage_cli.model_switch.get_model_capabilities", lambda *a, **k: None)
...
def test_picker_selection_resolves_named_custom_provider_model_id(monkeypatch):
    ...
    monkeypatch.setattr("sage_cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr(
        "sage_cli.model_switch.get_model_capabilities",
        lambda *a, **k: None,
    )
...
def test_custom_provider_no_key_singular_model_still_probes_live_models(monkeypatch):
    ...
    monkeypatch.setattr("sage_cli.models.fetch_api_models", fake_fetch_api_models)
...
def test_picker_endpoint_authorization_overrides_inferred_bearer(monkeypatch):
    from sage_cli.model_switch_providers import _fetch_picker_live_models
    ...
    monkeypatch.setattr("sage_cli.models_local.should_use_ollama_native_catalog", lambda *a, **k: True)
    monkeypatch.setattr("sage_cli.models_local.fetch_ollama_local_models", fake_native)
...
def test_lmstudio_picker_probes_active_config_base_url(monkeypatch):
    ...
    monkeypatch.setattr("sage_cli.models_local.fetch_lmstudio_models", _fake_fetch)
...
def test_resolve_custom_provider_passes_key_env():
    ...
    """
    from sage_cli.providers import resolve_custom_provider
...
def test_discovered_models_auto_saved_to_cache(monkeypatch):
    ...
    monkeypatch.setattr("sage_cli.models.fetch_api_models", fake_fetch_api_models)
    monkeypatch.setattr(
        "sage_cli.model_switch_providers._save_discovered_models_to_config",
...
def test_save_discovered_models_preserves_dict_form(monkeypatch):
    ...
    from sage_cli.model_switch_providers import _save_discovered_models_to_config
    ...
    monkeypatch.setattr("sage_cli.config.save_config", fake_save)
    monkeypatch.setattr(
...
def test_model_flow_named_custom_persists_discovered_models(monkeypatch):
    ...
    monkeypatch.setattr(
        "sage_cli.curses_ui.curses_radiolist", lambda *a, **k: 0
    )
    # No-op downstream writes so the test never touches a real config.
    monkeypatch.setattr("sage_cli.main_provider_setup._save_custom_provider", lambda *a, **k: None)
    monkeypatch.setattr("sage_cli.auth._save_model_choice", lambda *a, **k: None)
    monkeypatch.setattr("sage_cli.auth.deactivate_provider", lambda *a, **k: None)
    monkeypatch.setattr(
        "sage_cli.config.load_config",
        lambda: {"model": {}, "providers": {}, "custom_providers": []},
    )
    monkeypatch.setattr("sage_cli.config.save_config", lambda cfg: None)
    ...
    from sage_cli.model_setup_flows_custom import _model_flow_named_custom
...
def test_same_provider_switch_on_session_only_custom_endpoint_keeps_endpoint(monkeypatch):
    ...
    monkeypatch.setattr("sage_cli.model_switch.load_config", lambda: {"model": {"provider": "openrouter", "default": "x"}}, raising=False)
    monkeypatch.setattr(
