...
class TestGetCopilotModelContext:
    ...
    @patch("sage_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("sage_cli.models._urlopen_model_catalog_request")
    ...
    @patch("sage_cli.models.fetch_github_model_catalog", return_value=[])
