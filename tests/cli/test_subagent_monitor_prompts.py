...
def test_prompt_paint_yields_monitor_but_ordinary_paint_does_not(monkeypatch, paint_source):
    from sage_cli.cli_subagent_monitor import SubagentMonitor, build_monitor_application, install_dock
...
def test_secret_callback_yields_monitor_and_restores_composer():
    from sage_cli.cli_subagent_monitor import SubagentMonitor, build_monitor_application
    from sage_cli.cli_terminal_mixin import CLITerminalMixin
