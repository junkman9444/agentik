...
from sage_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/sage_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("sage_cli.lifecycle.invoke_hook")
@patch("sage_cli.lifecycle.finalize_session")
