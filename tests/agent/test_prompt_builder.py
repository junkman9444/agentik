...
class TestTruncateContent:
    ...
    def _reset_truncation_state(self, monkeypatch):
        ...
        monkeypatch.setattr("sage_cli.config.load_config", default_load_config)
        monkeypatch.setattr("sage_cli.config.load_config_readonly", default_load_config)
...
class TestDynamicContextFileCap:
    ...
    def _no_explicit_config(self, monkeypatch):
        ...
        monkeypatch.setattr("sage_cli.config.load_config_readonly", lambda: {})
