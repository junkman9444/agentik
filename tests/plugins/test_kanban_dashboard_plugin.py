...
def test_ws_events_rejects_when_token_required(tmp_path, monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "sage_cli.web_server_chat", stub)
    monkeypatch.setattr(sage_cli, "web_server_chat", stub, raising=False)
...
# tests/sage_cli/test_kanban_db.py. The OUTER fallback here is not, which
