...
def hermes_home(tmp_path, monkeypatch):
    ...
    if hasattr(sage_constants, "_HERMES_HOME_CACHE"):
        sage_constants._HERMES_HOME_CACHE = None  # type: ignore[attr-defined]
    return home
...
def test_env_loader_calls_bsm_when_enabled(tmp_path, monkeypatch):
    ...
    from sage_cli.env_loader import _apply_external_secret_sources
