"""Tests for _setup_feishu() in sage_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("sage_cli.config.save_env_value", side_effect=mock_save), \
         patch("sage_cli.config.get_env_value", side_effect=mock_get), \
         patch("sage_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("sage_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("sage_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("sage_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("sage_cli.cli_output.print_header"), \
         patch("sage_cli.cli_output.print_info"), \
         patch("sage_cli.cli_output.print_success"), \
         patch("sage_cli.cli_output.print_warning"), \
         patch("sage_cli.cli_output.print_error"), \
