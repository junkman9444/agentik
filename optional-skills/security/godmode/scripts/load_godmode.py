...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("SAGE_HOME", os.path.expanduser("~/.sage")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("SAGE_HOME", Path.home() / ".sage")) / "skills" / "red-teaming" / "godmode" / "scripts"
