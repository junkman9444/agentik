...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("AGENTIK_HOME", os.path.expanduser("~/.agentik")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("AGENTIK_HOME", Path.home() / ".agentik")) / "skills" / "red-teaming" / "godmode" / "scripts"
