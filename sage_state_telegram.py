"""Telegram DM topic-mode mixin for :class:`sage_state.SessionDB`."""
...
from sage_state_common import _PREVIEW_ELIGIBLE_SQL, _PREVIEW_RAW_SELECT, _sql_session_last_active

# caplog tests pin the "sage_state" logger name.
