...
home = tempfile.mkdtemp(prefix="dl_home_"); os.environ["AGENTIK_HOME"] = home
real_home = os.environ.get("HERMES_HOME_SOURCE", os.path.expanduser("~/.agentik"))  # credentials are copied from here into a temp home
