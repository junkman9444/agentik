...
Imports of sage_cli.main / auth / config / models stay lazy (main.py import cycle;
...
def _probe_custom_endpoint(effective_key: str, effective_url: str) -> tuple[dict, str]:
    ...
    from sage_cli.models import probe_api_models
...
def _model_flow_custom(config):
    ...
    from sage_cli.main_provider_setup import _auto_provider_name, _prompt_custom_api_mode_selection, _save_custom_provider
    from sage_cli.auth import _save_model_choice, deactivate_provider
    from sage_cli.config import custom_endpoint_key_env, get_env_value, save_env_value
...
def _discover_named_custom_models(provider_info: dict, api_key: str, configured_models: list, explicit_catalog: bool):
    ...
    from sage_cli.models import fetch_api_models, _get_ollama_native_headers
    ...
    if live_models:
        with contextlib.suppress(Exception):
            from sage_cli.model_switch_providers import _entry_credentials, _save_discovered_models_to_config
...
def _model_flow_named_custom(config, provider_info):
    ...
    from sage_cli.main_provider_setup import _custom_provider_api_key_config_value, _custom_provider_base_url_config_value, _save_custom_provider
    from sage_cli.auth import _save_model_choice
    from sage_cli.config import load_config, save_config
    from sage_cli.model_switch import _entry_models_discovered, _models_config_is_allowlist
