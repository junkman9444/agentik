...
def _warm_gateway_module() -> None:
    ...
    for mod in (
        "sage_cli.gateway",
        "sage_cli.auth",  # provider auth state → copilot_auth → subprocess
        "sage_cli.copilot_auth",
        "sage_cli.runtime_provider",
        "sage_cli.skin_engine",  # resolve_skin() config + skin engine init
        "sage_cli.inventory",  # provider catalogs + models.dev cache
