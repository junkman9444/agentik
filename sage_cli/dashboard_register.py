...
def _print_post_register_hint(
    *, client_id: str, portal_base_url: str, custom_redirect_uri: Optional[str],
    ...
    from sage_cli.config import get_env_path
...
def cmd_dashboard_register(args) -> None:
    ...
    from sage_cli.auth import AuthError, resolve_nous_access_token
    from sage_cli.config import is_managed, save_env_value
