...
from sage_cli.web_models import CronJobCreate
...
def _cron_profile_dicts() -> List[Dict[str, Any]]:
    ...
    from sage_cli.web_server_profiles import _fallback_profile_dicts
...
def _gateway_fire_endpoint(profile: str, home: Path) -> str:
    ...
    try:
        ...
        # expansion) — never a raw yaml.safe_load (tests/sage_cli/test_config_read_guard.py).
        from sage_constants import reset_hermes_home_override, set_hermes_home_override
