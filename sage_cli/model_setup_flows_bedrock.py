...
Imports of sage_cli.auth / config / models stay lazy (tests patch them at call time).
...
def _model_flow_bedrock_api_key(config, region, current_model=""):
    ...
    from sage_cli.auth import _resolve_api_key_provider_secret, ProviderConfig
