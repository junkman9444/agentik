...
from sage_cli.cli_output import print_info as _print_info
from sage_cli.colors import Colors, color
from sage_cli.config import cfg_get, load_config, save_config, get_env_value
from sage_cli.nous_compat import (
    NousSubscriptionFeatures, apply_nous_managed_defaults, get_nous_subscription_features)
from sage_cli.platforms import PLATFORMS as _PLATFORMS_REGISTRY
from sage_cli.toolset_scope import (
    _TOOLSET_PLATFORM_RESTRICTIONS, toolset_allowed_for_platform as _toolset_allowed_for_platform)
# Re-exports: keep ``sage_cli.tools_config.X`` callers and test patch targets resolving.
from sage_cli.tools_config_cua import (  # noqa: F401
...
from sage_cli.tools_config_post_setup import (  # noqa: F401
...
from sage_cli.tools_config_providers import (  # noqa: F401
...
from sage_cli.tools_config_mcp import (  # noqa: F401
...
def _xai_credentials_present() -> bool:
    ...
    try:
        from sage_cli.auth import _read_xai_oauth_tokens
...
def _get_plugin_toolset_keys() -> set:
    ...
    try:
        ...
        from sage_cli.plugins import get_plugin_toolset_keys_nowait
...
def enabled_mcp_server_names(config: dict) -> Set[str]:
    ...
    try:
        from sage_cli.plugins import get_portable_mcp_server_names_nowait
...
def tools_command(args=None, first_install: bool = False, config: dict = None):
    ...
    if getattr(args, "summary", False):
        ...
        return
    print(color("⚕ Sage Tool Configuration", Colors.CYAN, Colors.BOLD))
...
_PLUGIN_COMPAT_LAZY = {
    'MANAGED_FEATURE_COVERAGE_CATEGORY': ('sage_cli.nous_compat', 'MANAGED_FEATURE_COVERAGE_CATEGORY'),
    ...
    'format_nous_portal_entitlement_message': ('sage_cli.nous_compat', 'format_nous_portal_entitlement_message'),
