...
def import_agent_command(args) -> None:
    """Handle ``hermes import-agent`` (invoked from sage_cli.main)."""
    from sage_cli.config import get_config_path, load_config, save_config
    from sage_constants import get_hermes_home
    from sage_cli.setup import (Colors, color, print_header, print_info, print_success,
    ...
    print(color("│           ⚕ Sage — Import From Another Agent           │", Colors.MAGENTA))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA))
...
def print_import_report(report: Dict[str, Any], dry_run: bool) -> None:
    ...
    from sage_cli.setup import Colors, color, print_header, print_info
