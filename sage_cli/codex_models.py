...
DEFAULT_CODEX_MODELS: List[str] = [
    ...
    # not in the public API, so it stays out of the "openai" catalog in sage_cli/models.py.
...
# OpenAI API, so it intentionally stays out of the "openai" provider catalog in sage_cli/models.py — only
