...
from sage_cli.cli_modal_mixin import _gated_confirm
...
class CLIInfoMixin:
    ...
    def show_banner(self):
        ...
        from sage_cli.banner import build_welcome_banner
        self.console.clear()
        ctx_len = None
        ...
        from sage_cli.model_switch import is_nous_hermes_non_agentic
    ...
    def show_help(self, arg: str = ""):
        ...
        from sage_cli.commands import COMMANDS_BY_CATEGORY, HELP_SESSION_SUBGROUPS
        ...
        try:
            from sage_cli.skin_engine import get_active_help_header
    ...
    def handle_bang_shell(self, text: str) -> bool:
        ...
        from sage_cli.bang_shell import (
    ...
    def _print_random_tip(self) -> None:
        ...
        try:
            from sage_cli.tips import get_random_tip
            _tip = get_random_tip()
            try:
    ...
    def _toggle_verbose(self):
        ...
        if getattr(self, "_focus_view_enabled", False):
            ...
            try:
                from sage_cli.focus_view import FOCUS_CONFIG_KEY
    ...
    def _check_config_mcp_changes(self) -> None:
        ...
        from sage_cli.config import get_config_path as _get_config_path
