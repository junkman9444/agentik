...
from sage_cli.colors import Colors
from sage_cli.cli_output import prompt_yes_no
from sage_cli.curses_ui import curses_single_select
from sage_cli.mcp_catalog import (
...
def _configure_tools(name: str) -> None:
    ...
    from sage_cli.mcp_config import cmd_mcp_configure
