...
from sage_cli.dashboard_auth import list_session_providers
...
from sage_cli.dashboard_auth.prefix import prefix_from_request
from sage_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
from sage_cli.dashboard_auth.request_utils import (
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('sage_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
