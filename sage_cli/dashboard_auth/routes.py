...
from sage_cli.dashboard_auth import prefix as _prefix_mod
...
from sage_cli.dashboard_auth.cookies import (
    ...
    set_session_cookies)
from sage_cli.dashboard_auth.login_page import (
...
async def api_auth_ws_ticket(request: Request):
    ...
    sess = _require_session(request)
    from sage_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
