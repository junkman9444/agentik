...
Source installs report their git revision live via ``git rev-parse`` (``sage_cli/dump.py``,
``sage_cli/banner.py``). Inside the published Docker image ``.dockerignore`` excludes ``.git``,
