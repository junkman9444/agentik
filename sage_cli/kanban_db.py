...
def normalize_reasoning_effort(effort: Optional[str]) -> Optional[str]:
    ...
    from sage_constants import VALID_REASONING_EFFORTS
...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    workspace_path       TEXT,
    branch_name          TEXT,
    -- Optional link to a first-class Project (sage_cli/projects_db). When set,
...
def _canonical_assignee(assignee: Optional[str]) -> Optional[str]:
    ...
    if assignee is None:
        return None
    from sage_cli.profiles import normalize_profile_name
...
def _resolve_project_link(
    ...
    from sage_cli import projects_db as _pdb
...
def create_task(
    ...
    """
    from sage_cli.kanban_db_graph import initial_task_state, inherit_creator_origin
    from sage_cli.kanban_pr_acceptance import validate_contract
...
def complete_task(
    ...
    if not _parents_satisfied(conn, task_id):
        return False
    from sage_cli.kanban_pr_acceptance_store import prepare_acceptance, record_acceptance
...
def list_profiles_on_disk() -> list[str]:
    ...
    directly to avoid importing ``sage_cli.profiles`` at startup."""
    try:
        from sage_constants import get_default_hermes_root
...
from sage_cli.kanban_db_connect import (  # noqa: E402
    _INITIALIZED_PATHS,
    init_db,
    write_txn,
)
from sage_cli.kanban_db_workspace import (  # noqa: E402
    _cleanup_workspace,
    _is_managed_scratch_path,
    _managed_scratch_path_info,
    _scratch_workspace,
)
from sage_cli.kanban_db_dispatch import (  # noqa: E402
...
_PLUGIN_COMPAT_LAZY = {
    'DEFAULT_BUSY_TIMEOUT_MS': ('sage_cli.kanban_db_connect', 'DEFAULT_BUSY_TIMEOUT_MS'),
    'DEFAULT_LOG_BACKUP_COUNT': ('sage_cli.kanban_db_dispatch', 'DEFAULT_LOG_BACKUP_COUNT'),
    'DEFAULT_LOG_ROTATE_BYTES': ('sage_cli.kanban_db_dispatch', 'DEFAULT_LOG_ROTATE_BYTES'),
    'DERIVED_MAX_IN_PROGRESS_CEILING': ('sage_cli.kanban_db_dispatch', 'DERIVED_MAX_IN_PROGRESS_CEILING'),
    'DERIVED_MAX_IN_PROGRESS_FLOOR': ('sage_cli.kanban_db_dispatch', 'DERIVED_MAX_IN_PROGRESS_FLOOR'),
    'KANBAN_TERMINAL_TIMEOUT_GRACE_SECONDS': ('sage_cli.kanban_db_dispatch', 'KANBAN_TERMINAL_TIMEOUT_GRACE_SECONDS'),
    'KanbanDbCorruptError': ('sage_cli.kanban_db_connect', 'KanbanDbCorruptError'),
    'MEMORY_GUARD_MB_PER_WORKER': ('sage_cli.kanban_db_dispatch', 'MEMORY_GUARD_MB_PER_WORKER'),
    'RepairResult': ('sage_cli.kanban_db_connect', 'RepairResult'),
    'add_notify_sub': ('sage_cli.kanban_db_notify', 'add_notify_sub'),
    'advance_notify_cursor': ('sage_cli.kanban_db_notify', 'advance_notify_cursor'),
    'check_respawn_guard': ('sage_cli.kanban_db_dispatch', 'check_respawn_guard'),
    'claim_unseen_events_for_sub': ('sage_cli.kanban_db_notify', 'claim_unseen_events_for_sub'),
    'configured_max_in_progress': ('sage_cli.kanban_db_dispatch', 'configured_max_in_progress'),
    'connect': ('sage_cli.kanban_db_connect', 'connect'),
    'connect_closing': ('sage_cli.kanban_db_connect', 'connect_closing'),
    'count_notify_subs': ('sage_cli.kanban_db_notify', 'count_notify_subs'),
    'count_running_tasks': ('sage_cli.kanban_db_dispatch', 'count_running_tasks'),
    'count_running_tasks_other_boards': ('sage_cli.kanban_db_dispatch', 'count_running_tasks_other_boards'),
    'derive_default_max_in_progress': ('sage_cli.kanban_db_dispatch', 'derive_default_max_in_progress'),
    'detect_crashed_workers': ('sage_cli.kanban_db_dispatch', 'detect_crashed_workers'),
    'detect_stale_running': ('sage_cli.kanban_db_dispatch', 'detect_stale_running'),
    'dispatch_once': ('sage_cli.kanban_db_dispatch', 'dispatch_once'),
    'enforce_max_runtime': ('sage_cli.kanban_db_dispatch', 'enforce_max_runtime'),
    'has_spawnable_ready': ('sage_cli.kanban_db_dispatch', 'has_spawnable_ready'),
    'has_spawnable_review': ('sage_cli.kanban_db_dispatch', 'has_spawnable_review'),
    'heartbeat_worker': ('sage_cli.kanban_db_dispatch', 'heartbeat_worker'),
    'list_notify_subs': ('sage_cli.kanban_db_notify', 'list_notify_subs'),
    'purge_stale_done_notify_subs': ('sage_cli.kanban_db_notify', 'purge_stale_done_notify_subs'),
    'reap_worker_zombies': ('sage_cli.kanban_db_dispatch', 'reap_worker_zombies'),
    'reconcile_orphaned_running': ('sage_cli.kanban_db_dispatch', 'reconcile_orphaned_running'),
    'remove_notify_sub': ('sage_cli.kanban_db_notify', 'remove_notify_sub'),
    'repair_db': ('sage_cli.kanban_db_connect', 'repair_db'),
    'resolve_max_in_progress': ('sage_cli.kanban_db_dispatch', 'resolve_max_in_progress'),
    'resolve_workspace': ('sage_cli.kanban_db_workspace', 'resolve_workspace'),
    'review_dispatch_enabled': ('sage_cli.kanban_db_dispatch', 'review_dispatch_enabled'),
    'rewind_notify_cursor': ('sage_cli.kanban_db_notify', 'rewind_notify_cursor'),
    'run_daemon': ('sage_cli.kanban_db_dispatch', 'run_daemon'),
    'set_branch_name': ('sage_cli.kanban_db_workspace', 'set_branch_name'),
    'set_workspace_path': ('sage_cli.kanban_db_workspace', 'set_workspace_path'),
    'unseen_events_for_sub': ('sage_cli.kanban_db_notify', 'unseen_events_for_sub'),
    'worker_log_rotation_config': ('sage_cli.kanban_db_dispatch', 'worker_log_rotation_config'),
}
