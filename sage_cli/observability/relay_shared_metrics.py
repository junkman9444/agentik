...
def _raw_config() -> dict[str, Any]:
    """Read-only config snapshot (lazy import: tests patch ``sage_cli.config``).
...
def _resolved_send_config():
    ...
    from sage_cli.observability.shared_metrics_send_config import resolve_send_config

    return resolve_send_config(_raw_config())


def _reconcile_store_consent(store: SharedMetricsStore, send_enabled: bool) -> None:
    from sage_cli.observability.shared_metrics_sender import reconcile_send_consent
...
_PLUGIN_COMPAT_LAZY = {
    'CLIENT_ACTIVE_MARK': ('sage_cli.observability.shared_metrics_contract', 'CLIENT_ACTIVE_MARK'),
    'MODEL_CALL_PROFILE_MODEL': ('sage_cli.observability.shared_metrics_contract', 'MODEL_CALL_PROFILE_MODEL'),
    'SCHEMA_KEY': ('sage_cli.observability.shared_metrics_contract', 'SCHEMA_KEY'),
    'SCHEMA_VERSION': ('sage_cli.observability.shared_metrics_contract', 'SCHEMA_VERSION'),
    'SKILL_LIFECYCLE_MARK': ('sage_cli.observability.shared_metrics_contract', 'SKILL_LIFECYCLE_MARK'),
    'SKILL_LOAD_MARK': ('sage_cli.observability.shared_metrics_contract', 'SKILL_LOAD_MARK'),
    'TOOL_APPROVAL_MARK': ('sage_cli.observability.shared_metrics_contract', 'TOOL_APPROVAL_MARK'),
    'TOOL_CALL_SCOPE': ('sage_cli.observability.shared_metrics_contract', 'TOOL_CALL_SCOPE'),
    'model_call_fields': ('sage_cli.observability.shared_metrics_contract', 'model_call_fields'),
    'skill_lifecycle_fields': ('sage_cli.observability.shared_metrics_contract', 'skill_lifecycle_fields'),
    'skill_load_fields': ('sage_cli.observability.shared_metrics_contract', 'skill_load_fields'),
    'task_start_fields': ('sage_cli.observability.shared_metrics_contract', 'task_start_fields'),
    'task_terminal_fields': ('sage_cli.observability.shared_metrics_contract', 'task_terminal_fields'),
    'task_terminal_state': ('sage_cli.observability.shared_metrics_contract', 'task_terminal_state'),
    'tool_approval_outcome': ('sage_cli.observability.shared_metrics_contract', 'tool_approval_outcome'),
    'tool_category': ('sage_cli.observability.shared_metrics_contract', 'tool_category'),
    'tool_terminal_fields': ('sage_cli.observability.shared_metrics_contract', 'tool_terminal_fields'),
}
