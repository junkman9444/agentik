...
Pure-data leaf module — must not import from sage_cli.config. Comments are the user-facing
docs of config.yaml.
"""
...
DEFAULT_CONFIG = {
    ...
    "whatsapp": {
        # reply_prefix: None = built-in "⚕ *Sage*" header; "" disables; \n allowed.
    },
    ...
    "security": {  # Security: pre-exec scanning via tirith plus related guards.
        ...
        # sage_cli/security_advisories.py.
        "acked_advisories": [],
