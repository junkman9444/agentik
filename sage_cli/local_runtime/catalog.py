...
from sage_cli.local_runtime.estimator import HardwareBudget, LayerKind, ModelProfile, ctx_bytes
from sage_cli.local_runtime.gguf import model_id_from_stem
...
_CATALOG_URL = ("https://raw.githubusercontent.com/NousResearch/hermes-agent"
                "/main/sage_cli/local_runtime/catalog.json")
_SCHEMA_VERSION = 1
...
def _packaged_catalog() -> "tuple[CatalogEntry, ...]":
    ...
    raw = files("sage_cli.local_runtime").joinpath("catalog.json").read_text(encoding="utf-8")
