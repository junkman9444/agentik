...
from sage_cli.local_runtime.gguf import model_id_from_stem, read_gguf_header
...
def _restore_grown_window(model_id: str, profile: ModelProfile, budget: HardwareBudget,
    ...
    try:
        from sage_cli.local_runtime.growth import load_window_overrides
...
def generate_presets(models_dir: Path, budget: HardwareBudget, preset_path: Path,
    ...
    from sage_cli.local_runtime.bootstrap import staged_in
