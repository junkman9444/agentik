...
from sage_cli.local_runtime.gguf import SPLIT_PART_RE, model_id_from_stem
...
def _detect_gpu_vendor() -> str | None:
    ...
    from sage_cli.local_runtime.hardware import _nvidia_smi_path
...
def _stop_state_server(state: dict) -> None:
    ...
    server."""
    from sage_cli.local_runtime.endpoint import _pid_alive
...
def _generate_presets(mdir: Path, preset_path: Path) -> Path | None:
    ...
    """
    from sage_cli.local_runtime.hardware import probe_budget
    from sage_cli.local_runtime.presets import generate_presets
