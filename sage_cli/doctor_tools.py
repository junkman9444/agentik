...
import subprocess
import sys
from sage_cli.doctor_platform import _system_package_install_cmd
from sage_cli.doctor_report import Finding, _fail_and_issue, check_bool, check_info, check_ok, check_warn, doctor_check
from sage_cli.vercel_auth import describe_vercel_auth
from sage_constants import agent_browser_runnable, is_termux as _is_termux
...
def _apply_doctor_tool_availability_overrides(available: list[str], unavailable: list[dict]) -> tuple[list[str], list[dict]]:
    ...
    from sage_cli.doctor_state import _honcho_is_configured_for_doctor
...
def _check_terminal_backend(should_fix: bool, f: Finding) -> None:
    ...
    try:
        from sage_constants import is_container as _is_container
