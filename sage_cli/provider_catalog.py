...
come from :data:`sage_cli.auth.PROVIDER_REGISTRY` (credential truth); ``display_name`` /
...
def provider_catalog() -> list[ProviderDescriptor]:
    ...
    PROVIDER_REGISTRY = _safe_import("sage_cli.auth", "PROVIDER_REGISTRY", {})
    OPTIONAL_ENV_VARS = _safe_import("sage_cli.config", "OPTIONAL_ENV_VARS", {})
    ...
    HERMES_OVERLAYS = _safe_import("sage_cli.providers", "HERMES_OVERLAYS", {})
    try:
