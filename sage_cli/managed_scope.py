...
DISTINCT from ``sage_cli.config.is_managed()`` / ``HERMES_MANAGED`` (a coarse package-manager
...
def apply_managed_overlay(config: dict) -> dict:
    ...
    try:
        ...
        from sage_cli.config import _deep_merge, _expand_env_vars, _normalize_root_model_keys
