...
from sage_cli import config as config_mod, web_deps
from sage_cli.local_runtime import (
...
def _assign_default(job: Dict[str, Any], model_id: str) -> None:
    ...
    web_deps.late("_apply_model_assignment_sync", "sage_cli.web_server_config")("main", "llamacpp", model_id, "", "", "")
