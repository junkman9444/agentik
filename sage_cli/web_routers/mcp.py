...
from sage_cli.web_server_mcp import _mcp_oauth_flows, _mcp_server_summary, _normalize_mcp_server_create
from sage_cli.web_models import MCPCatalogInstall, MCPEnabledToggle, MCPServerCreate, MCPServersReplace
from sage_cli.web_routers._common import (
...
_run_dashboard_mcp_oauth = late("_run_dashboard_mcp_oauth", "sage_cli.web_server_mcp")
...
def _mcp_oauth_callback_url(request: Request, server_name: str) -> str:
    ...
    from sage_cli.dashboard_auth.prefix import prefix_from_request, resolve_public_url
...
async def add_mcp_server(body: MCPServerCreate, profile: Optional[str] = None):
    from sage_cli.mcp_config import _get_mcp_servers, _save_bearer_auth_token, _save_mcp_server
...
async def replace_mcp_servers(body: MCPServersReplace, profile: Optional[str] = None):
    ...
    from sage_cli.mcp_config import _replace_mcp_servers
...
async def remove_mcp_server(name: str, profile: Optional[str] = None):
    from sage_cli.mcp_config import _remove_mcp_server
...
async def test_mcp_server(name: str, profile: Optional[str] = None):
    ...
    from sage_cli.mcp_config import _get_mcp_servers, _oauth_tokens_present, _probe_single_server
...
async def install_mcp_catalog_entry(body: MCPCatalogInstall, profile: Optional[str] = None):
    ...
    from sage_cli import mcp_catalog
    from sage_cli.config import validate_env_var_name_for_write
