...
from sage_cli.pty_session import RegistryFull
from sage_cli.web_deps import LateState, late
from sage_cli.web_server_chat import (
...
_active_session_file_for_channel = late("_active_session_file_for_channel", "sage_cli.web_server_chat")
_profile_scope = late("_profile_scope", "sage_cli.web_server_profiles")
_resolve_chat_argv_async = late("_resolve_chat_argv_async", "sage_cli.web_server_chat")
_resolve_profile_dir = late("_resolve_profile_dir", "sage_cli.web_server_profiles")
_ws_auth_reason = late("_ws_auth_reason", "sage_cli.web_server_chat")
_ws_client_reason = late("_ws_client_reason", "sage_cli.web_server_chat")
_ws_host_origin_reason = late("_ws_host_origin_reason", "sage_cli.web_server_chat")
...
def _ws_auth_mode() -> str:
    ...
    from sage_cli.web_server_chat import _LOOPBACK_HOSTS
...
async def console_ws(ws: WebSocket) -> None:
    ...
    try:
        from sage_cli.console_engine import HermesConsoleEngine
...
async def pty_ws(ws: WebSocket) -> None:
    from sage_cli.web_server_chat import PTY_REGISTRY, PtyBridge, PtyUnavailableError, _PTY_BRIDGE_AVAILABLE, _RESIZE_RE
