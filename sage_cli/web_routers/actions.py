...
from sage_cli.config import format_docker_update_message, recommended_update_command_for_method
from sage_cli.web_deps import LateState, late
from sage_cli.web_server_gateway import _ACTION_LOG_FILES
...
detect_install_method = late("detect_install_method", "sage_cli.config")
get_hermes_home = late("get_hermes_home", "sage_cli.config")
_ACTION_COMMANDS = LateState("_ACTION_COMMANDS", "sage_cli.web_server_gateway")
_ACTION_IDS = LateState("_ACTION_IDS", "sage_cli.web_server_gateway")
_ACTION_PROCS = LateState("_ACTION_PROCS", "sage_cli.web_server_gateway")
_ACTION_RESULTS = LateState("_ACTION_RESULTS", "sage_cli.web_server_gateway")
...
def _server_path(name: str) -> Path:
    ...
    import sage_cli.web_server_gateway as gw
...
async def check_hermes_update(force: bool = False):
    ...
    try:
        from sage_cli.banner import check_for_updates, upstream_commits_behind
