...
Extracted from ``sage_cli.web_server``; helpers/state that tests monkeypatch on
...
from sage_cli.config import OPTIONAL_ENV_VARS, get_env_path, redact_key
from sage_cli.web_deps import LateState, late
from sage_cli.web_server_gateway import _restart_gateway_after
from sage_cli.web_server_messaging import (
...
from sage_cli.web_routers._common import http_failure
from sage_cli.web_models import (
...
_profile_scope = late("_profile_scope", "sage_cli.web_server_profiles")
_resolve_profile_dir = late("_resolve_profile_dir", "sage_cli.web_server_profiles")
_restart_gateway_after_whatsapp_onboarding = late("_restart_gateway_after_whatsapp_onboarding", "sage_cli.web_server_messaging")
_telegram_onboarding_request_sync = late("_telegram_onboarding_request_sync", "sage_cli.web_server_messaging")
_whatsapp_session_path = late("_whatsapp_session_path", "sage_cli.web_server_messaging")
_write_platform_enabled = late("_write_platform_enabled", "sage_cli.web_server_messaging")
load_env = late("load_env", "sage_cli.config")
load_config = late("load_config", "sage_cli.config")
read_runtime_status = late("read_runtime_status", "gateway.status")
remove_env_value = late("remove_env_value", "sage_cli.config")
save_env_value = late("save_env_value", "sage_cli.config")
_gateway_subcommand = late("_gateway_subcommand", "sage_cli.web_server_gateway")
...
def _ensure_whatsapp_bridge_dependencies(bridge_dir: Path) -> None:
    ...
    from sage_constants import find_node_executable, with_hermes_node_path
