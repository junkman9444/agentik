...
from sage_constants import INDICATOR_STYLES
...
class CommandDef:
    ...
    # Key in ``sage_cli.slash_exec.EXECUTORS`` (a string, not a callable: keeps this module
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("subscription", "Subscription management (not available in this fork)", "Info",
               cli_only=True, aliases=("upgrade",)),
    CommandDef("login", "Free-tier sign-in (not available in this fork)", "Info",
               busy_policy="dispatch", desktop="settings"),
    CommandDef("topup", "Billing top-up (not available in this fork)", "Info"),
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'discord_skill_commands_by_category': ('sage_cli.commands_platforms', 'discord_skill_commands_by_category'),
    'slack_app_manifest': ('sage_cli.commands_platforms', 'slack_app_manifest'),
    'slack_native_slashes': ('sage_cli.commands_platforms', 'slack_native_slashes'),
    'slack_subcommand_map': ('sage_cli.commands_platforms', 'slack_subcommand_map'),
    'telegram_bot_commands': ('sage_cli.commands_platforms', 'telegram_bot_commands'),
    'telegram_menu_commands': ('sage_cli.commands_platforms', 'telegram_menu_commands'),
    'telegram_menu_max_commands': ('sage_cli.commands_platforms', 'telegram_menu_max_commands'),
}
