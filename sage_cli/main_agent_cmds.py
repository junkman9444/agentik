...
def cmd_memory(args):
    ...
    if sub == "off":
        ...
        from sage_cli.memory_setup import memory_command
        memory_command(args)
...
def cmd_tools(args):
    ...
    if action in {"list", "disable", "enable"}:
        ...
        from sage_cli.tools_config import run_post_setup_command
...
def cmd_skills(args):
    ...
    if action == "config":
        ...
        from sage_cli.skills_config import skills_command as skills_config_command
        skills_config_command(args)
    elif action in ("trust", "untrust"):
        _cmd_skills_trust(args)
    else:
        from sage_cli.skills_hub import skills_command
        skills_command(args)
