...
class CLITuiMixin:
    ...
    def _get_tui_prompt_symbols(self) -> tuple[str, str]:
        ...
        """
        try:
            from sage_cli.skin_engine import get_active_prompt_symbol
    ...
    def _build_tui_style_dict(self) -> dict[str, str]:
        ...
        try:
            from sage_cli.skin_engine import get_prompt_toolkit_style_overrides
    ...
    def _tui_handle_ignored_terminal_sequence(self, event):
        ...
        sage_cli.pt_input_extras registers focus reports (CSI I / CSI O) as Keys.Ignore at the
    ...
    def _tui_enter_overlay(self, event) -> bool:
        ...
        if self._model_picker_state:
            try:
                ...
                from sage_cli.model_switch import resolve_persist_behavior
    ...
    def _tui_handle_prompt_stash(self, event):
        ...
        """
        from sage_cli.prompt_stash import ACTION_RESTORED, ACTION_STASHED, resolve_ctrl_s
        buf = event.app.current_buffer
    ...
    def _tui_build_key_bindings(self):
        ...
        from sage_cli.cli_subagent_monitor import modal_prompt_active, open_monitor, toggle_dock
        for key in ('c-t', 'f6'):
    ...
    def _tui_build_layout(self, kb):
        ...
        cli_ref = self
        from sage_cli.cli_subagent_monitor import install_dock
        install_dock(self)
