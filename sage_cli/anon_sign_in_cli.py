...
from sage_cli.anon_sign_in import Code, SignInState, UPGRADE_CANCELLED, UPGRADE_START
...
def render_sign_in_cli_code(
    ...
    from sage_cli.auth_device_flow import _print_device_code_instructions
...
def render_sign_in_cli(
    *, timeout_seconds: float = 15.0, open_browser: bool = False, chat: bool = False,
    ...
    """
    from sage_cli import anon_auth as _core
...
def upgrade_guest(args) -> int:
    ...
    """
    from sage_cli import anon_auth as _core
    from sage_cli.auth_device_flow import _is_remote_session
