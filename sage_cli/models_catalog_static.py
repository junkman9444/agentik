...
maps. Split out of ``sage_cli.models``.
"""
...
def _codex_curated_models() -> list[str]:
    ...
    from sage_cli.codex_models import DEFAULT_CODEX_MODELS, _finalize_codex_models
...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    # (see sage_cli/model_setup_flows.py); validated live against a GCP project (global region).
    "vertex": [
...
# sage_cli/web_server.py + ``partition_nous_models_by_tier``, which may hit the Portal.
