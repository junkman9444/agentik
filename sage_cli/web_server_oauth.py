...
def _copilot_acp_status() -> Dict[str, Any]:
    ...
    try:
        from sage_cli.auth import get_external_process_provider_status
...
def _nous_plain_poller(session_id: str, sess: Dict[str, Any]) -> None:
    ...
    """
    from sage_cli.web_server_profiles import _profile_scope
    from sage_cli.auth import _poll_for_token, persist_nous_credentials, refresh_nous_oauth_from_state
