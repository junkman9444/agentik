...
Sibling of :mod:`sage_cli.plugins_cmd` (the installer core, enable/disable state and console helpers
...
from sage_cli.plugin_catalog import (
...
def looks_like_catalog_name(identifier: str) -> bool:
    ...
    from sage_cli.plugins_cmd import _URL_SCHEMES
...
def resolve_catalog_name(identifier: str, console) -> PluginCatalogEntry:
    ...
    from sage_cli.plugins_cmd import _fail
...
def repin_catalog_plugin(target: Path, sidecar: dict) -> tuple[str, bool]:
    ...
    from sage_cli.plugins_cmd import PluginOperationError, _get_enabled_set, _save_enabled_set
...
def cmd_update_catalog(name: str, target: Path, sidecar: dict, console) -> None:
    from sage_cli.plugins_cmd import PluginOperationError, _fail
...
def _render_entries(entries: List[PluginCatalogEntry], console) -> None:
    from sage_cli.plugins_cmd import _table
...
def cmd_search(term: str = "", *, json_output: bool = False) -> None:
    ...
    from sage_cli.plugins_cmd import _console
...
def cmd_info(name: str) -> None:
    ...
    from sage_cli.plugins_cmd import _console, cmd_show
