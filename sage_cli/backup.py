...
from sage_state_dbfile import RETIRED_GENERATION_DIR_SUFFIX
from utils import (
...
def _restore_profile_wrappers(hermes_root: Path) -> List[str]:
    ...
    except ImportError:  # sage_cli.profiles unavailable (fresh install)
...
def _revive_gateway_after_import(hermes_root: Path) -> None:
    ...
    if hermes_root != native_default and any(
        ...
        return
    try:
        from sage_cli.gateway import ensure_gateway_service, _is_service_running
