"""Plugin-owned durable state and namespaced settings helpers (split out of sage_cli.plugins)."""
...
from sage_cli.plugins_manifest import _portable_skill_namespace
