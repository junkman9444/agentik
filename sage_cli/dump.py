...
from sage_cli.config import get_hermes_home, get_env_path, get_project_root, load_config
...
def _get_git_commit(project_root: Path) -> str:
    ...
    if value:
        return value
    try:
        from sage_cli.build_info import get_build_sha  # deferred: keeps dump cheap on non-dump paths
...
def _gateway_status() -> str:
    ...
    try:
        from sage_cli.gateway import get_gateway_runtime_snapshot
