...
from sage_constants import agent_browser_runnable, find_node_executable
...
def _has_hermes_agent_browser() -> bool:
    from sage_constants import get_hermes_home  # late import: tests patch sage_constants.get_hermes_home
