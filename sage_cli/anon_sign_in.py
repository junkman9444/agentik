...
def run_sign_in(
    ...
    *client_factory* is the HTTP client seam, ``client_factory(timeout_seconds, verify)``.
    """
    from sage_cli import anon_auth as _core
    from sage_cli.auth import PROVIDER_REGISTRY, _resolve_verify
    from sage_cli.auth_device_flow import _request_device_code
    from sage_cli.auth import _nous_http_client
