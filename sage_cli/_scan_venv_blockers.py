"""Standalone venv-process scan for JSON consumption (``python -m sage_cli._scan_venv_blockers``).
...
def _updater_owned_backend_entry(pid: int, cmdline: str) -> dict | None:
    ...
    """
    try:
        from sage_cli.update_cmd import _hermes_holder_subcommand  # noqa: PLC0415
    ...
    if purpose not in _UPDATER_STOPPABLE_PURPOSES:
        return None
    try:
        from sage_cli.process_identity import ledger_entries, spawner_is_dead  # noqa: PLC0415
