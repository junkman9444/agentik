...
from sage_cli.main_tui_launch import _npm_lifecycle_env
...
def _register_linux_desktop_entry() -> None:
    ...
    from sage_cli.main import PROJECT_ROOT
    try:
        from sage_cli.linux_desktop_entry import install_desktop_entry, is_supported
        if not is_supported():
            return
...
def _install_desktop_workspace_deps(npm: str, env: dict) -> None:
    ...
    from sage_cli.main import PROJECT_ROOT
    from sage_cli.main_web_build import _run_npm_install_deterministic
