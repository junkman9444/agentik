...
Imports of sage_cli.config / azure_detect stay lazy (tests patch them at call time).
...
from sage_cli.model_setup_flows_common import _HTTP, _ask, _commit_model_config, _load_config_model_section, _say
