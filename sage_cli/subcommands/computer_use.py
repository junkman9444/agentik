...
from sage_cli.subcommands._shared import add_json_flag


def _cu_install(args) -> int:
    from sage_cli.tools_config import _cua_driver_contract_status, install_cua_driver
...
def _cu_status(args) -> int:
    import os as _os
    import subprocess
    from sage_cli.tools_config import _cua_driver_contract_status
    ...
    version = ""
    try:
        from sage_cli.tools_config import _cua_driver_env
        ...
        pass
    from sage_cli.tools_config import _cua_version_summary
