...
:mod:`sage_cli.commands` (which re-exports both classes) so the registry module stays
...
from sage_cli.commands import COMMANDS, SUBCOMMANDS
...
def _personality_completions(sub_text: str, sub_lower: str):
    ...
    from sage_cli.personality import describe_personality
