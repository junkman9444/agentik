...
from sage_cli.config import get_env_path, get_env_value, get_hermes_home, load_config
from sage_cli.models import provider_label
from sage_cli.runtime_provider import resolve_requested_provider
from sage_cli.vercel_auth import describe_vercel_auth
from sage_cli.status_auth import (  # renderers wired into _SECTIONS below
...
def _render_gateway(ctx):
    ...
    try:
        from sage_cli.gateway import get_gateway_runtime_snapshot, _format_gateway_pids
...
def _render_sessions(ctx):
    ...
    if gateway_rows:
        ...
        if freshest > 0:
            from sage_cli.timefmt import relative_time
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'get_nous_portal_account_info': ('sage_cli.nous_compat', 'get_nous_portal_account_info'),
