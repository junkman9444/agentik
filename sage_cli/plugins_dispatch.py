...
Mixed into :class:`sage_cli.plugins.PluginManager`. ``_resolve_hook_callback_timeout`` stays on
...
from sage_cli.middleware import OBSERVER_SCHEMA_VERSION
...
class PluginDispatchMixin:
    ...
    def invoke_hook(self, hook_name: str, **kwargs: Any) -> List[Any]:
        ...
        """
        from sage_cli.plugins import _resolve_hook_callback_timeout
    ...
    def _deliver_event(self, item: _QueuedPluginEvent) -> None:
        ...
        from sage_cli.plugins import resolve_plugin_command_result
        with self._event_lock:
