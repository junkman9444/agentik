...
# Install tree root (this file lives at <install_root>/sage_constants.py). Used by secure_parent_dir() to
...
def venv_bin_dir(venv_dir, *, windows: bool | None = None) -> Path:
    ...
    Canonical helper for venv layout. This was open-coded in seven places across four ``sage_cli`` modules
    ...
    lived 2400 lines away in another function. A few sites outside ``sage_cli``
